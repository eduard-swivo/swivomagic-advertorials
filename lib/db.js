...
export async function createArticle(articleData) {
    try {
      ...
      INSERT INTO articles (
        ...
        hero_image, advertorial_label, hook, story, benefits,
        urgency_box, cta_link, cta_text, published
      ) VALUES (
        ${slug}, ${title}, ${category}, ${author}, ${published_date},
        ${excerpt}, ${hero_image}, ${advertorial_label}, ${hook},
        ${JSON.stringify(story)}, ${JSON.stringify(benefits)},
        ${JSON.stringify(urgency_box)}, ${cta_link}, ${cta_text}, ${published}
      )
      RETURNING *
    `;
